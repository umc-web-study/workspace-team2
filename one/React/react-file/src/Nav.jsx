        ...
        <header className="header">
            ...
            <div className="content">
                ...
                <div className="nav-left-wrapper">
                    <div className="logo">
                    <a href="https://www.inflearn.com/" class="image">
                        <svg width="110" id="icon_brand_logo" class="brand_logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 433 90">
                ...
                <div class="nav-right">
                    ...
                    <div class="nav-right-item">
                        <a role="button" class="sign-up">
                            로그인
                        </a>
                        <a href="https://www.inflearn.com/signup" class="join">
                            회원가입
                        </a>
                    </div>
                </div>
